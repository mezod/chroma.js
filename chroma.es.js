...
Color.prototype.rgb = function(round$$1=true) {
...
function hsl2rgb() {
    ...
    if (s === 0) {
        ...
        [r,g,b] = [round$1(c[0]*255),round$1(c[1]*255),round$1(c[2]*255)];
    }
...
for (let key of Object.keys(brewer)) {
